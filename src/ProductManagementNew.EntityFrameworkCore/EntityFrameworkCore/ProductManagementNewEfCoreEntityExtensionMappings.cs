...
public static class ProductManagementNewEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE ProductManagementNewModuleExtensionConfigurator CLASS (in the Domain.Shared project)
