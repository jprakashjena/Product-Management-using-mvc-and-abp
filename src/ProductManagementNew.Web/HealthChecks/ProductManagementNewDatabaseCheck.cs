...
public class ProductManagementNewDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ProductManagementNewDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
