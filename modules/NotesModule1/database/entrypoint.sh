...
/opt/mssql-tools/bin/sqlcmd -S sqlserver -U SA -P $SA_PASSWORD -Q "CREATE DATABASE [$NotesModule1_DB]"

/opt/mssql-tools/bin/sqlcmd -d $AuthServer_DB -S sqlserver -U sa -P $SA_PASSWORD -i migrations-AuthServerHost.sql
/opt/mssql-tools/bin/sqlcmd -d $NotesModule1_DB -S sqlserver -U sa -P $SA_PASSWORD -i migrations-NotesModule1.sql