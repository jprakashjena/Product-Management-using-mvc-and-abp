(function ($) {
    ...
    $(function () {
        ...
        $("#IdentityUsersWrapper select#IdentityRole, #IdentityUsersWrapper select#OrganizationUnit, #IdentityUsersWrapper input#IsLockedOut, #IdentityUsersWrapper input#NotActive").change(function (e) {
            _dataTable.ajax.reload();
        });
